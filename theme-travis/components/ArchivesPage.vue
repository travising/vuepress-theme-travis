        ...
        <template v-for="(item, index) in postsList">
          ...
          >
            <ModuleTransition delay="0.08">
              <h2 v-if="recoShowModule">
                <i class="iconfont tc-huodongmulupeizhi" style="font-size:1.4rem"></i>{{year}}
              </h2>
            </ModuleTransition>
          </li>
          <li :key="index">
...
export default {
  ...
  // travis:for transition
  mixins: [TitleBadgeMixin, moduleTransitonMixin],
