<template>
  <div class="home-wrapper">
    ...
    >
      ...
      >
        <header class="hero">
          <ModuleTransition>
            <img
              v-if="recoShowModule && homeData.heroImage"
          ...
          <ModuleTransition delay="0.04">
            <h1
              v-if="recoShowModule && homeData.heroText"
              id="main-title"
            >{{ homeData.heroText }}</h1>
          </ModuleTransition>
          <ModuleTransition delay="0.08">
          <p
            v-if="recoShowModule && homeData.tagline"
            class="description"
          >{{ homeData.tagline }}</p>
          </ModuleTransition>
          <p
            class="action"
            v-if="recoShowModule && homeData.actionText && homeData.actionLink"
          >
            <NavLink
              class="action-button"
              :item="actionLink"
        ...
        <ModuleTransition delay="0.12">
          <div
            class="features"
            v-if="recoShowModule && homeData.features && homeData.features.length && !isMQMobile"
          >
            <div
              class="feature"
    ...
    <ModuleTransition delay="0.2">
      <MainLayout v-if="recoShowModule" >
        <template #mainLeft>
          <!-- 简约版文章列表 -->
          <UpdateArticle
            class="card-box"
...
export default {
  ...
  mixins: [moduleTransitonMixin],// travis for transiton
  components: { NavLink, MainLayout, PostList, UpdateArticle, BloggerBar, CategoriesBar, TagsBar, Pagination, ModuleTransition },
  created () {
